...
export default function Terms() {
  return (
    <Layout>
      ...
      <h2>OVERVIEW</h2>
      <p>
        This website is operated by Upkeep. Throughout the site, the terms “we”,
        “us” and “our” refer to Upkeep. Upkeep offers this website, including
        ...
        offer, acceptance is expressly limited to these Terms of Service. You
        can review the most current version of the Terms of Service at any time
        on this page. We reserve the right to update, change or replace any part
      ...
      <p>
        ...
        shall Upkeep, our directors, officers, employees, affiliates, agents,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Upkeep and our parent,
